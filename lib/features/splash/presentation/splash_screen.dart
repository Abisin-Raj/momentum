...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  Future<void> _initSequence() async {
    await ref.read(appDatabaseProvider).normalizeLegacyRestDayThumbnails();
  ...
  Future<void> _checkPermissions() async {
    ...
    if (missing.isNotEmpty && mounted) {
      ...
      await showModalBottomSheet<bool>(
        ...
        isDismissible: false,
        builder: (context) =>
            PermissionBottomSheet(missingPermissions: missing),
      );
    ...
    return Container(
      ...
      child: Image.asset(
        ...
        errorBuilder: (context, error, stackTrace) {
          ...
          return Icon(Icons.broken_image_outlined, color: iconColor, size: 40);
        },
      ),
    );
  }
